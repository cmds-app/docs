...
[Download PDF](learning.pdf){ .md-button }
...
- 'Shortcuts' tab is highlighted, and several shortcut tools are available for users to quickly access the most commonly used tools in CMDS (e.g., My Training Plan).
