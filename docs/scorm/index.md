...
[Scoop](https://openscorm.com/scoop) is our top recommendation, especially if you're just getting started. It's open-source, inexpensive, and easy to use. It connects to CMDS through Single Sign-On, so adding a SCORM course to a learning activity takes just a few clicks.
